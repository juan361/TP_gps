...
void PrintGpsData(const gps_data *data){
    ...
    printf("latitude : %ld",data->latitude); // en degres, latitude nord devra etre positive alors que celle de sud devra etre negative
    printf("longitude : %ld",data->longitude); // en degres, longitude est devra etre positive alors que celle de ouest devra etre negative
